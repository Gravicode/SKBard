...
/// </summary>
public sealed class PaLMChatCompletion :IAIService
{
    ...
    public async Task<string> GenerateMessageAsync(PaLMChatHistory chat, AIRequestSettings requestSettings = null, CancellationToken cancellationToken = default)
    {
